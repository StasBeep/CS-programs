...
namespace Laba12Var24
{
    ...
    public class StrInPOut:SsOperations
    {
        public void CallPublMetod(string str)
        {
            ...
            ForvardINT = Convert.ToInt32(str.Substring(11));
            MonthOperations();
        }
        public void OutPut(ListBox pro)
        {
            ...
            if (month > 0 && month < 10)
                monthStr = "0" + month;
            pro.Items.Add(dayStr + "." + monthStr + "." + yy.ToString());
        }
    }
}
